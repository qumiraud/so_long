...
/*   Updated: 2025/02/28 10:31:08 by qumiraud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_to_right(t_image img)
{
		...
		|| ft_count_collec(img.map) == 0))
	{
		...
		img.img_ptr = mlx_xpm_file_to_image(img.win.mlx_ptr,
				"C_F_F/T/F_T.xpm", &(img.width), &(img.height));
		...
		img.img_ptr = mlx_xpm_file_to_image(img.win.mlx_ptr,
				"C_F_F/P_R.xpm", &(img.width), &(img.height));
		mlx_put_image_to_window(img.win.mlx_ptr, img.win.mlx_win,
...
void	move_to_left(t_image img)
{
		...
		|| ft_count_collec(img.map) == 0))
	{
		...
		img.map[y][x - 1] = 'P';
		img.img_ptr = mlx_xpm_file_to_image(img.win.mlx_ptr,
				"C_F_F/P_L.xpm", &(img.width), &(img.height));
		mlx_put_image_to_window(img.win.mlx_ptr, img.win.mlx_win,
			img.img_ptr, (x - 1) * 48, y * 48);
		mlx_destroy_image(img.win.mlx_ptr, img.img_ptr);
		img.img_ptr = mlx_xpm_file_to_image(img.win.mlx_ptr,
...
void	move_up(t_image img)
{
		...
		|| ft_count_collec(img.map) == 0))
	{
		...
		mlx_destroy_image(img.win.mlx_ptr, img.img_ptr);
		img.img_ptr = mlx_xpm_file_to_image(img.win.mlx_ptr,
				"C_F_F/P_B.xpm", &(img.width), &(img.height));
		mlx_put_image_to_window(img.win.mlx_ptr, img.win.mlx_win,
